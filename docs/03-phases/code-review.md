...
3. Require the PR to state the risk tier explicitly (see [.github/PULL_REQUEST_TEMPLATE.md](../../.github/PULL_REQUEST_TEMPLATE.md)) so reviewers aren't guessing how much scrutiny a change needs.
