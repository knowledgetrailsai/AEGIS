...
|---|---|---|
| [spec-template.md](spec-template.md) | Writing a spec before implementation starts | [Spec-Driven Development](../docs/practices/spec-driven-development.md), [Requirements & Spec phase](../docs/03-phases/requirements-spec.md) |
| [adr-template.md](adr-template.md) | Recording an architecture decision and its trade-offs | [Architecture & Design phase](../docs/03-phases/design.md) |
